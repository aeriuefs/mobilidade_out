                ...
                <table class="striped">
                    ...
                    <tbody>
                        ...
                        while ($res = mysqli_fetch_assoc($resultado)) {
                         ...
                         <button class="btn waves-effect waves-light indigo lighten-2 " type="submit" name="solicitar"> Solicitar </button> </form></td></tr>');
                            }
                        }
                        ?>
                        ...
                        while ($res = mysqli_fetch_assoc($resultado)) {
                            ...
                            echo('<td><form style="display: inline;" method="post" action="candidato_recurso_detalhes.php" >
                                <input type="hidden" name="id" value="' . $res['id'] . '"/>
                                    <input type="hidden" name="edital" value="' . $res['edital'] . '"/>
                         <button class="btn waves-effect waves-light indigo lighten-2 " type="submit" name="acompanhar"> Visualizar </button> </form></td></tr>');
                        }
                        ?>
