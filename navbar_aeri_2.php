<div class="navbar-fixed">
    ...
    <nav class="grey darken-4">
        ...
        <div class="nav-wrapper container">
            ...
            <a href="colegiado_home.php" class="brand-logo"><i class="material-icons">home</i></a>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down uppercase">
                ...
                <li><a href=""><span class="new badge blue accent-1" data-badge-caption="">Matheus Pires</span></a></li>
