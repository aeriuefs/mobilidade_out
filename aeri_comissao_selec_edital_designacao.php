...
<body>
    ...
    <main>
        ...
        <section class="section container">
            ...
            <h4 class="center-align uppercase">Designações</h4> 

            <p>Selecione o edital do qual deseja obter informações.</p>
            ...
            <table class="striped">
                ...
                <tbody>
                    ...
                    while ($res = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo('<td><form style="display: inline;" method="post" action="aeri_comissao_designacoes.php" > '
