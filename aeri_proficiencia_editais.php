...
<body>
    ...
    <main>
        ...
        <section class="section container">
            ...
            <p>Selecione o edital para realizar a marcação de provas.</p>
            ...
            <table class="striped">
                ...
                <tbody>
                    ...
                    while ($res = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo('<td><form style="display: inline;" method="post" action="aeri_proficiencia_marcacoes.php" > <input type="hidden" name="edital" value="' . $res['numero_edital'] . '"/>
