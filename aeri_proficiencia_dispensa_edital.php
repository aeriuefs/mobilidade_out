...
<body>
    ...
    <main>
        ...
        <section class="section container">
            ...
            <p>Selecione o edital do qual deseja informações.</p>
            ...
            <table class="striped">
                ...
                <tbody>
                    ...
                    while ($res = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo('<td><form style="display: inline;" method="post" action="aeri_proficiencia_dispensa_candidato.php" > <input type="hidden" name="edital" value="' . $res['numero_edital'] . '"/>
